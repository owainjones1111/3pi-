...
ISR( PCINT0_vect ) {
    ...
    } else if(state_e1 == 1 || state_e1 == 7 || state_e1 == 8 || state_e1 == 14) {
      count_e1 = count_e1 - 1;

    } else if(state_e1 == 2 || state_e1 == 4 || state_e1 == 11 || state_e1 == 13) {
      count_e1 = count_e1 + 1;
    } // Continue this if statement as necessary.
    //Serial.println("Wheel one: ");
